...
/*
출처:
http://blog.naver.com/PostView.nhn?blogId=bgpoilkj&logNo=221972990489&parentCategoryNo=&categoryNo=85&viewDate=&isShowPopularPosts=false&from=postView
 */
public class MapActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapView.MapViewEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setItemName("정자역");
        marker.setTag(0);
        MapPoint mapPoint = MapPoint.mapPointWithGeoCoord(37.36703119176418 , 127.10850960576184 );
